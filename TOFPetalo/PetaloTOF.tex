...
PET scanner exploiting the scintillating properties of liquid xenon. We find that an excellent CRT of 60-70 ps (depending on the PDE of the sensor) can be obtained in the scanner is instrumented with silicon photomultipliers (SiPMs) sensitive to the ultraviolet light emitted by xenon. Alternatively, a CRT of 120 ps can be obtained instrumenting the scanner with (much cheaper) blue-sensitive SiPMs coated with a suitable wavelength shifter.
...
Recent research, using small setups, has found much better results. For example Ferri et al. (Performance of FBK high-density SiPM technology coupled to Ce:LYSO and Ce:GAGG for TOF-PET; Alessandro Ferri, Alberto Gola, Nicola Serra, Alessandro Tarolli, Nicola Zorzi and Claudio Piemonte; Phys. Med. Biol. 59 (2014) 869?880 doi:10.1088/0031-9155/59/4/869) report measurements with using a pair of small LYSO crystals 
...
shifted to $\sim$ 430 nm (figure \ref{fig.tpb}) and re-emitted isotropically. The decay constant of TPB has been measured to be 2.2 ns in thin films (Journal of Luminescence
Volume 81, Issue 4, June 1999, Pages 285?291
Study of poly(methyl methacrylate) thin films doped with laser dyes
Jinman Huang, Vlasoula Bekiari, Panagiotis Lianosa, Stelios Couris
).
...
\end{figure}
 ...
 intrinsic resolution of the LYSO setup for $PDE=1$~is $\sim$30 ps.  This values can be taken as the absolute best limit of the CRT in LXe and LYSO. For a PDE of 50\%, (best value of conventional SiPMs) the CRT in LYSO is $\sim$ 40 ps, while for a PDE of 15\% (best value of VUV-sensitive SiPMs) the CRT in LXe is $\sim$ 30 ps.   
...
\begin{figure}[!bhtp]
	\centering
	\includegraphics[scale=0.4]{../img/CRTvsPDE_phys_LXeLYSONoJitterFstPE.png}
...
Figure \ref{fig.crt2} shows the CRT as a function of the
 ...
 The CRT of the LXe setup for $PDE=1$~ is now $\sim$30 ps for both LXe and LYSO. 
 For a PDE of 50\% the CRT in LYSO is $\sim$ 50 ps, while for a PDE of 15\%  the CRT in LXe is $\sim$ 60 ps. 
...
Figure \ref{fig.crt2} shows the CRT as a function of the
 ...
 PDE for blue light,  however, the CRT is computed taking into account the effect of the TPB absorption and subsequent re-emission).  The CRT in this case is around 110 ps. The CRT worsens considerably due to the extra delay introduced by the TPB decay and the reduced photon detection efficiency due to the TPB absorption efficiency (80\%) and the effect introduced by the re-emission (only 50\% of the re-emitted photon point into the SiPM). Notice, on the other hand, that the refraction index of LXe in the blue region is almost exactly matched with that of the SiPM window, and therefore Fresnel reflections are negligible. The overall efficiency introduced by the coating is, therefore $\sim$40\%. 
